    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          {/* Datos informativos de la oferta seleccionada (no afectan el cálculo) */}
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div>
              <p className="text-muted-foreground">Producto / oferta inmobiliaria</p>
            ...
            <div>
              <p className="text-muted-foreground">Ubicación declarada</p>
              <p className="font-medium">
